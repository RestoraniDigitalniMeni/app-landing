    ...
    <span>{benefits[(startIndex + 1) % benefits.length].text}</span>
        ...
        <div className="formWrapper">
          ...
          <div className="formCard">
            <h3>Pošalji podatke za besplatan test</h3>
            <p>Digitalizuj svoj restoran</p>
...
<div className="pricing-card yearly highlight">
  ...
  <p className="desc">
    Najbolja opcija — ušteda 69€/godišnje. Potpuni pristup svim funkcijama + podrška
  </p>
</div>
